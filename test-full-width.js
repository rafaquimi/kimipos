// Script para probar el ancho completo del papel
const puppeteer = require('puppeteer');
const { exec } = require('child_process');
const fs = require('fs');
const path = require('path');

// Función para generar HTML optimizado para impresoras térmicas con ancho completo
...
async function testFullWidth() {
  try {
    console.log('🔍 Probando ancho completo del papel (80mm)...');
    ...
    console.log('\n📋 Generando HTML con ancho completo...');
    ...
    const pdfPath = path.join(tempDir, `full_width_${Date.now()}.pdf`);
    ...
    console.error('❌ Error en prueba full width:', error);
  }
}
