// Script para probar el nuevo ancho de columna más amplio
const puppeteer = require('puppeteer');
const { exec } = require('child_process');
const fs = require('fs');
const path = require('path');

// Función para generar HTML optimizado para impresoras térmicas con columna más ancha
...
async function testWideColumn() {
  try {
    console.log('🔍 Probando columna más ancha (76mm)...');
    ...
    console.log('\n📋 Generando HTML con columna más ancha...');
    ...
    const pdfPath = path.join(tempDir, `wide_column_${Date.now()}.pdf`);
    ...
    console.error('❌ Error en prueba wide column:', error);
  }
}
